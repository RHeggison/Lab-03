...
author: "Rhyanna, Callum, Adrian, Ciara, Ciaran, Omar- Team Name"
date: "`r Sys.Date()`"
...
Inconsistent scale, proportions aren't right
...
No colur, difficult to interpret.
...
Overlapped data and unclear abbreviations 
...
Long format has each case as a separate row, wide format doesn't repeat values in the first column \
